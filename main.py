...
ending.write('結局')
end = ending.radio('結局',['未完成 (+0分)', '息潮的代價 (+80分)', '命運的寵兒 (+350分)', '靜謐時代 (+350分)'],label_visibility='collapsed')
...
emergency_score = (e_3_1 + e_3_2 + e_3_3) * 40 + e_4_1 * 50 + e_4_2 * 50 + e_4_3 * 60 + e_4_4 * 100 \
...
# 【特殊挑戰】事件，
# 真相+50分(無漏時+90分)，”喜”從箱來+50分(無漏+箱子全收時+90分)，狂信如火(無漏時)+50分。漏護盾血也算漏。
